...
using ECommerce.Application.Features.Security.Registration.BeginRegistration;
using ECommerce.Application.Features.Security.Registration.RequestRegistrationVerifyEmail;
using ECommerce.Application.Features.Security.Registration.VerifyRegistration;
using MediatR;
...
namespace ECommerce.Application.Features.Security.Registration;
